...
app.get("/jokes/:id", (req, res) => {
    ...
    const joke = jokes.find(joke => { return joke.id === id });
    res.json(joke);
});
...
app.delete("/jokes/:id", (req, res) => {
  ...
  if (index > -1) { 
    ...
    res.status(200).send("The item have been removed.");
  }
  else {
    res.status(404).send("Couldn't find item with specified id.");
  }
...
app.delete("/all", (req, res) => {
  if(req.headers.apikey === masterKey) {
    ...
    jokes.splice(0, length);
    res.status(200).send("All elements have been deleted.");
  }
  else {
